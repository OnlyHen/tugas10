...
<div class="card"> 
 ...
 <button onclick="location.href='reportpdf.php';" id="reportpdf">Konvert Pdf</button>
    <button onclick="location.href='reportexcel.php';" id="reportexcel">Konvert excel</button>
 </div>
</div>
</div>
</div>
